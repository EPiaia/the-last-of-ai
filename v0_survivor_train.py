...
import os
import v0_survivor_env # Even though we don't use this class here, we should include it here so that it registers the WarehouseRobot environment.
...
def run_q(episodes, is_training=True, render=False):
    ...
    plt.plot(sum_steps)
    plt.savefig('v0_the_last_of_us_solution.png')
